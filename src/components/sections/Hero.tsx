  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <motion.p 
            className="text-neon-cyan font-accent tracking-[0.3em] text-sm sm:text-base mb-4 uppercase"
          ...
          <h1 className="text-5xl sm:text-7xl md:text-8xl font-black mb-6 leading-tight">
            ...
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-neon-cyan via-neon-magenta to-neon-purple text-glow-cyan">MUSIC</span>
          </h1>
          ...
          <motion.div 
            className="mt-16 inline-block glass-card px-6 py-3 border-neon-magenta/30"
            animate={{ scale: [1, 1.02, 1] }}
            transition={{ duration: 2, repeat: Infinity }}
          >
            <p className="text-neon-magenta font-display font-bold italic tracking-widest">
